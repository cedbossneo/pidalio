...
then
    ...
    echo "Using ID: $ID"
    docker run -e ID=${ID} -e FS_PATH=/var/etcd -v /opt/etcd:/var/etcd --rm --name=etcd -p 2379:2379 -p 2380:2380 -p 4001:4001 -p 7001:7001 cedbossneo/etcd-cluster-on-docker
fi
