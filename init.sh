...
docker run -e FS_PATH=/var/etcd -v /var/etcd:/opt/etcd  --rm --name=etcd -e NODE_COUNT=3 -p 2379:2379 -p 2380:2380 -p 4001:4001 -p 7001:7001 cedbossneo/etcd-cluster-on-docker
