...
/opt/bin/kubectl --kubeconfig=/home/core/.kube/config create secret generic ceph-admin-key --type="kubernetes.io/rbd" --from-file=ceph-admin-key --namespace=monitoring
/opt/bin/kubectl --kubeconfig=/home/core/.kube/config create secret generic ceph-admin-key --type="kubernetes.io/rbd" --from-file=ceph-admin-key
